...
public class DriveBase extends SubsystemBase {
  ...
  public void periodic() {
    double boost = RobotContainer.stick.getRawButton(Joystick.Buttons.speedUpBind) ? 0.8 : 0.4;

    // Hiểu đơn giản chỗ này là nếu ấn nút lái bên nào thì biến driving bên đó trả
    // về 1 còn ko thì trả về 0
    int drivingRight = RobotContainer.stick.getRawAxis(Joystick.Buttons.driveRightBind) > 0 ? 1 : 0;
    int drivingLeft = RobotContainer.stick.getRawAxis(Joystick.Buttons.driveLeftBind) > 0 ? 1 : 0;
